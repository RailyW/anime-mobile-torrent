...
6. 已在 Bangumi 首页提供关键词搜索 UI、输入防抖、搜索按钮即时提交和结果列表。
...
1. Flutter 工程骨架。
2. Bangumi 登录、当前用户信息、搜索输入防抖、搜索、条目详情、我的动画收藏分页列表、单条收藏读写、动画章节状态同步、章节类型筛选、已加载章节展开查看、章节分页加载更多和批量标记到第 N 话看过。
